      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
        <View className="flex-1 justify-center px-6">
          <View className="items-center mb-10">
            ...
            <Text className="text-base text-text-secondary mt-2">Community for animal welfare</Text>
          </View>
          ...
          <TouchableOpacity className="mt-6 bg-primary rounded-lg py-4 items-center" onPress={handleSignIn}>
